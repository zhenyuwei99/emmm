# File: fcc.py
# Author: Zhenyu Wei
# This file will contain the precast for Face-centered cubic
...
class Fcc(InorganicBase):
    """
    element: Element name for fcc
    """
    def __init__(self, world, lattice_constant=1, element='FCC') -> None:
