# File: bcc.py
# Author: Zhenyu Wei
# This file will contain the precast for Body-centered cubic
...
class Bcc(InorganicBase):
    """
    element: Element name for bcc
    """
    def __init__(self, world, lattice_constant=1, element='BCC') -> None:
